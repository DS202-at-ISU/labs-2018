...
Get the data into a format where the ten columns are replaced by three: Time, Death and Return. Time should be a number between 1 and 5; Death and Return are binary variables with values "yes" and "no".
