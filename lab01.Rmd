...
3. Name your repository `lab1-your-gitname`
...
1.  Go to the `lab1-your-gitname` repository main page. Click on `README.md`, then click "edit this file". Add the following information into the `README.md` file:
    -  Name?
...
Now it is time to collaborate with a partner.  Navigate to one of your team members' repository by typing the url directly into your address bar (take a round-robin approach). In order to edit someone else's repository you usually follow this simplified work flow: 
...
- You should now have a copy of your partners repository, `lab1-their-gitname`. 
...
For the submission in Canvas, submit your Markdown / R Markdown file with 
  a. a table of team members, their github handle,  the number of successful pull requests made, and the number of accepted pull requests
  b. a list with at least 3 tips of how to make working with git/github easier.


Note: 

a. make sure that none of the numbers in the above list are 0, i.e. each team member has to have at least one successful pull request made and accepted. Help out your team member in case they are stuck. 
b. you only need to make one submission per team. 

Due date: You have time until Monday at 10 pm to submit the markdown/R markdown file in Canvas.
