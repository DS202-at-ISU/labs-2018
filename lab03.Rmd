---
title: "DS 202 - lab #3: Ames Housing"
...
1. Log into github 
2. Pick one team member to create a repository called 'lab3'
...
Write a separate code chunk for each variable, once all the data manipulation is done, show the values in a barchart or histogram.
...
Save the final data set as RDS file (binary R data) using the command:`saveRDS(HAPPY, "newfilename.rds")`
