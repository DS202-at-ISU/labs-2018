...
3. For each of the questions below  provide at least one graphic as a basis for your answer.
    ...
    2. How do ratings compare across different company locations? Focus on the three locations with the most ratings (`U.S.A., France, Canada`):
    ```{r}
    top3 <- filter(choco, Company.Location %in% c("U.S.A.", "France", "Canada"))
    ```
...
In Canvas, submit an RMarkdown file with: 
  ...
  d. one paragraph commenting on the workflow.
...
Start work together and upload an initial R markdown file with your answers to questions 1 and 2 to your github repository.

Then split the work and work individually on one aspect for 30 mins. 

Upload your work at the time to the repository and discuss.
